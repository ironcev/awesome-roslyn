...
- [Clean Code](https://github.com/blowin/BlowinCleanCode) - Roslyn-based C# code analyzer that aims to provide a set of rules that helps to simplify code and make it cleaner.
