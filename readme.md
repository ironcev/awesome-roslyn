...
- [dotnet-exec](https://github.com/WeihanLi/dotnet-exec) - Runs C# script/program from the .NET CLI, including NuGet package references and custom entrypoint support
