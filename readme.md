...
- [Roslyn Analyzer Cookbook](https://github.com/tom-englert/RoslynAnalyzerCookbook/) - A step-by-step tutorial, focusing on testing (TDD) and integrating custom analyzers directly into the solution; also covers the less known suppression analyzers.
